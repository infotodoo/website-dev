odoo.define('website_login.fetch_job', function(require) {
    ...
    $("input[name='ide'], input[name='numero_mascota'], input[name='identificacion'] ").on('input', function(e) { $(this).val($(this).val().replace(/[^0-9]/g, '')); });
    ...
    $("#valor_auxilio_alimentacion, #valor_aux_alimentacion_pro, #Valor_Auxili_de_Rodamiento, #valor_aux_rodamiento_pro, #Valor_Auxilio_de_Celular, #Valor_Medicina_Prepagada, #Valor_Bonos, #Valor_Comisiones, #Valor_Otro_Beneficio, #valor_aux_movilizacion").on('input', function(e) { $(this).val($(this).val().replace(/[^0-9\.]/g, '')); });
    ...
    $("input[name='cide']").on('input', function(e) { $(this).val($(this).val().replace(/[^0-9]/g, '')); });
    ...
    // Section 7 ######################################################################
    $('#no_personas_nucleo_familiar').on('input', function(e) { $(this).val($(this).val().replace(/[^0-9]/g, '')); });

    $('#no_personas_estado_incapacidad').on('input', function(e) { $(this).val($(this).val().replace(/[^0-9]/g, '')); });
    // Section 8 ######################################################################
    ...
    $('#tipo_contrato').on('change', function() {
        if (this.value == 'OBRA LABOR') {
            ...
            $('#tipo_contrato_a, #tipo_contrato_b').hide()
        ...
        if ((this.value == 'FIJO') || (this.value == 'MEDIO TIEMPO')) {
            ...
            document.getElementById("tiempo_de_contrato_inicial").required = false;
    ...
    $('#nivel_riesgo_arl').on('change', function() {
        ...
        } else if (this.value == '5 RIESGO V') { document.getElementById("nivel_riesgo").value = '6.960%'; }
    });
    ...
    $('#aux_alimentacion').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#aux_alimentacion_a, #aux_alimentacion_b').hide()
    ...
    $('#aux_alimentacion_pro').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#aux_alimentacion_pro_a, #aux_alimentacion_pro_b').hide()
    ...
    $('#aux_rodamiento').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#aux_rodamiento_a, #aux_rodamiento_b').hide()
    ...
    $('#aux_rodamiento_pro').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#aux_rodamiento_pro_a, #aux_rodamiento_pro_b').hide()
    ...
    $('#aux_celular').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#aux_celular_a, #aux_celular_b').hide()
    ...
    $('#medicina_prepagada').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#medicina_prepagada_a, #medicina_prepagada_b').hide()
    ...
    $('#comisiones').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#comisiones_a, #comisiones_b').hide()
    ...
    $('#aux_movilizacion').on('change', function() {
        if (this.value == 'SI') {
            ...
            $('#aux_movilizacion_a, #aux_movilizacion_b').hide()
    ...
    $('#save_cargo').on('click', function() {
        ...
        if (isValid == true) {
            if ((modificacion == false) && (eliminacion == false)) { alert("por favor elija modificación o eliminación"); } else {
    ...
    $("#modificacion").change(function() {
        ...
        if (this.checked) {
            if (eliminacion_check == true) { document.getElementById('eliminacion').checked = false; }
        }
    });
    $("#eliminacion").change(function() {
        var modificacion_check = document.getElementById('modificacion').checked;
        if (this.checked) {
            if (modificacion_check == true) { document.getElementById('modificacion').checked = false; }
        }
    });
    // Section 36 ######################################################################
